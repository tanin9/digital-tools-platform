...
import emptyCart from "../../assets/images/cart-image.png";
        ...
        {carts.length === 0 ? (
          ...
          <div>
            {carts.map((item) => (
              <div key={item.id}>
                <div
                  className="bg-gray-100 p-3 mb-4 rounded-2xl 
                ...
                >
                  ...
                  <div>
                    <button
                      ...
                      className="btn btn-ghost rounded-4xl text-red-600 font-semibold p-2"
                    >
                      Remove
                    </button>
                  </div>
