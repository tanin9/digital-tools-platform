    ...
    <div className="container mx-auto grid md:grid-cols-2 py-4 px-7 justify-around items-center gap-3">
      <div className="md:px-0 lg:px-12 space-y-4">
        ...
        <div className="my-3 flex gap-2">
          <a
            className="btn hover:-translate-y-1 hover:scale-110 hover:bg-white
            transition delay-150 duration-300
            bg-linear-to-r from-[#4F39F6] to-[#9514F5] text-white rounded-4xl"
          >
            Explore Products <FaArrowRight className="text-lg font-bold" />
          </a>
          <a
            className="btn hover:-translate-y-1 hover:scale-110 hover:bg-white
            transition delay-150 duration-300
          border-[#4F39F6] rounded-4xl"
          >
            <CiPlay1 className="text-xl text-[#4F39F6] font-bold" />{" "}
            <span className="  text-[#4F39F6] font-bold">Watch Demo</span>
          </a>
        </div>
      </div>
